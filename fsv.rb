class Fsv < Formula
  ...
  url "https://github.com/Joao-Filh0/fsv/archive/refs/tags/0.0.16.tar.gz"
  sha256 "8f53fa834202e71e7c19836494f053cfa0dc82e88e170c0c9dba1b10c51ba8ef"
  version "1.0.16"
  ...
  def install
    ...
    venv.pip_install ["requests","argparse","urllib3","chardet","idna","certifi","colorama"]
